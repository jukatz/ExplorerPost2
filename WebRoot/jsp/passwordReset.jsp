		...
		<div class="jumbotron">
			<div class="container-fluid">
				...
				<div id="resetPassword">
					<form:form id="command" method="POST" action="password">
						<h3 class="col-sm-offset-4">Change Password</h3>
						<br>
						<div class="container">

							<div class="form-group form-inline row">
								<label for="curr"
									class="col-sm-3 col-sm-offset-2 text-right">Current Password</label>
								<form:password
									cssClass="form-control input-sm pull-left col-sm-4"
									id="curr" path="currPassword"/>
							</div>
							<!--end currPassword -->
							<div class="form-group form-inline row">
								<label for="password"
